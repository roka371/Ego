	...
	$(document).ready(function() {
		...
		*/
		...
		$('#feedList').sortable(
			...
			$.post("http://egodecal.webfactional.com/index.php/query/feed_position", { feeds: $('#feed_list').sortable('serialize') } );
		});
		
		*/
		
		//RightList Sortable with pos_id
		
		/*
		1. Makes the items in rightList sortable.
		
		$('#feedList').sortable();
		
		2. Upon sort, changed the data-posID of all the rightList, if necessary
		3. Reflect the changes to feed_position() using ajax.
		*/
		/*
