	...
	$(document).ready(function() {
		...
		*/
		...
		$('.etbox_clip').live('click', function() {
			var permalink = $(this).parent().parent().children('.entry_header').children('.entry_headline').children('.entry_permalink').attr('href');
			var title = $(this).parent().parent().children('.entry_header').children('.entry_headline').children('.entry_permalink').children('.entry_title').text();
			var source = $(this).parent().parent().children('.entry_header').children('.entry_info').children('.entry_source').text();
			var date = $(this).parent().parent().children('.entry_header').children('.entry_info').children('.entry_date').text();
      		var content = $(this).parent().parent().children('.entry_content').html();
		...
		$('.esp_share').live('submit', function(){
			...
			var date = root.children('.entry_header').children('.entry_info').children('.entry_date').text();
      		...
      		var target = root.children('.entry_footer').children('.etbox_share').children('.share_count').text();
