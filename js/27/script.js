		...
		*/
		...
		$('#waypoint').waypoint(function(event, direction) {
			if (direction === 'down'){
				...
				$('#scrollbox').append('<a href=\"javascript:window.history.forward();\"><img src=\"http://egodecal.webfactional.com/right_toolbox/icons/next.png\" \/><\/a>');
				$('#scrollbox').append('<a href=\"javascript:window.scrollTo(0, 0);\"><img src=\"http://egodecal.webfactional.com/right_toolbox/icons/top.png\" \/><\/a>');
